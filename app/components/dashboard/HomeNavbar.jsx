...
const HomeNavbar = () => {
  ...
  return (
    <div className='h-32 text-[#FEFEFE] montserrat p-5 header-bg bg-[#1F1F1F] shadow-[0_4px_10px_rgba(255,255,255,0.1)]'> 
      {/* Left Profile */}
      <div className="flex space-x-3">
        ...
        <div className="flex flex-col">
          <p className='p-text montserrat font-semibold'>Hello, MONU KUMAR</p>
